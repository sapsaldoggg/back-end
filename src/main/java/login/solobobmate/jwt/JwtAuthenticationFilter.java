...
import login.solobobmate.controller.memberDto.LoginDto;
import login.solobobmate.domain.Member;
import login.solobobmate.result.ErrorResult;
...
//        //body 로 전송하는것으로 수정 ( 토큰 값만 )
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response, AuthenticationException failed) throws IOException, ServletException {
        ...
        String error_json = objectMapper.writeValueAsString(new ErrorResult("로그인에 실패했습니다"));
        response.setCharacterEncoding("UTF-8");
        response.setContentType("application/json");
